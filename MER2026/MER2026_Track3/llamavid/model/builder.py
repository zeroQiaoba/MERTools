...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    ...
    if 'vid' in model_name.lower():
        ...
        if model_base is not None:
            ...
            cfg_pretrained = AutoConfig.from_pretrained(model_path)
            cfg_pretrained.mm_vision_tower = '/data3/renyong/zeroqiaoba/LLaMA-VID-main/model_zoo/LAVIS/eva_vit_g.pth'
            model = LlavaLlamaAttForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
