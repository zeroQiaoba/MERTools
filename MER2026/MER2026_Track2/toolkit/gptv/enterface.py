...
emos = ['happiness', 'anger', 'disgust', 'fear', 'surprise', 'sadness']
emo2idx = {}
...
if __name__ == '__main__':
    ...
    # data_root = '/share/home/lianzheng/emotion-data/eNTERFACE'
    # save_root = '/share/home/lianzheng/emotion-data/gpt4v-evaluation/enterface'
    ...
    # save_root = '/root/dataset/enterface'
    ...
    [ 53  18   4   5  12  78]
    [ 37  12   8   1   4 112]]
    Class Accuracies: ['57.30%', '8.72%', '5.85%', '1.08%', '7.06%', '64.37%']
    UAR: 24.06%, WAR: 23.78%
    '''
    ...
    ## step1: pre-process for dataset [random sample 2 frames]
    # data_root = '/share/home/lianzheng/emotion-data/eNTERFACE'
    # save_root = '/share/home/lianzheng/emotion-data/gpt4v-evaluation/enterface-threeframe'
    # select_samples(data_root, save_root)

    ## step2: gain prediction results [ok Kang's machine]
    bsize, xishus = 8, [2, 2, 2] # reduce cost
    save_root = '/root/dataset/enterface-threeframe'
    image_root = os.path.join(save_root, 'video')
    gpt4v_root = os.path.join(save_root, 'gpt4v')
    save_order = os.path.join(save_root, 'order.npz')
    # for flag in ['flag1', 'flag1', 'flag1', 'flag2', 'flag2', 'flag3', 'flag4']:
    ...
    [ 52  29   7   8  30  81]
    [ 20  32   6   2   9 141]]
    Class Accuracies: ['73.81%', '25.12%', '15.17%', '2.94%', '14.49%', '67.14%']
    UAR: 33.11%, WAR: 33.28%
    '''

    ## 进一步分析结果并得到更多统计信息
    # gpt4v_path = 'E:\\Dataset\\gpt4v-evaluation\\enterface-threeframe\\label-gpt4v.csv'
    # further_report_results(gpt4v_path)
    '''
    sample number: 1287
    gpt4v => WAR: 33.28%, UAR: 33.11%
    random guess => WAR: 16.87%, UAR: 16.87%
    frequent guess => WAR: 16.71%, UAR: 16.67%
    '''

    ## 绘制混淆矩阵图，进一步分析GPT4V的预测结果
    gpt4v_path = 'E:\\Dataset\\gpt4v-evaluation\\enterface-threeframe\\label-gpt4v.csv'
    save_path  = 'E:\\Dataset\\gpt4v-evaluation\\enterface-threeframe\\enterface-threeframe-cm.png'
