...
def preprocess_dataset(data_root, save_root):
    ...
    '''
    {'happiness': 31, 'others': 96, 'disgust': 61, 'repression': 27, 'surprise': 24, 'fear': 2, 'sadness': 7}
    {'happiness': 31, 'others': 96, 'disgust': 61, 'repression': 27, 'surprise': 24}
    '''
...
if __name__ == '__main__':
    ...
    '''
    pred sample number: 239
    gt sample number: 239
    gtp4v performance: 14.64
    {'disgust': 61, 'happiness': 31, 'surprise': 24, 'repression': 27, 'others': 96}
    old number: 239
    new number: 239
    Confusion Matrix:
    [[ 9  0  0 18  4]
    ...
    [ 1  0  4 18  4]
    [ 1  0  4 84  7]]
    Class Accuracies: ['29.03%', '0.00%', '1.64%', '66.67%', '7.29%']
    emos = ['happiness', 'surprise', 'disgust', 'repression', 'others']
    '''

     ## 进一步分析结果并得到更多统计信息
    # gpt4v_path = 'E:\\Dataset\\gpt4v-evaluation\\casme2\\label-gpt4v.csv'
    # further_report_results(gpt4v_path)
    '''
    sample number: 239
    gpt4v acc: 14.64
    random guess acc: 18.33
    frequent guess acc: 40.17
    '''

    ## 绘制混淆矩阵图，进一步分析GPT4V的预测结果
    gpt4v_path = 'E:\\Dataset\\gpt4v-evaluation\\casme2\\label-gpt4v.csv'
    save_path  = 'E:\\Dataset\\gpt4v-evaluation\\casme2\\casme2-cm.png'
