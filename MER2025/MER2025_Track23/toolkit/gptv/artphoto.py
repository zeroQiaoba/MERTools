...
def preprocess_dataset(data_root, save_root):
    ...
    for line in lines:
        ...
        save_path = os.path.join(save_image, newname+'.jpg')
...
def get_results_and_update_label(gpt4v_root, label_path, store_path, posneg=False):
    ...
    print (f'gt sample number: {len(set(names))}') # 603
    name2gt = {}
...
if __name__ == '__main__':
    ...
    # 806 -> 801 -> gtp4v performance: 80.40

    ## 进一步分析结果并得到更多统计信息
    # gpt4v_path = 'E:\\Dataset\\gpt4v-evaluation\\artphoto\\label-gpt4v.csv'
    # further_report_results(gpt4v_path)
    '''
    sample number: 801
    gpt4v acc: 80.40
    random guess acc: 50.41
    frequent guess acc: 53.06
    '''

    ## 绘制混淆矩阵图，进一步分析GPT4V的预测结果
    # gpt4v_path = 'E:\\Dataset\\gpt4v-evaluation\\artphoto\\label-gpt4v.csv'
    # save_path  = 'E:\\Dataset\\gpt4v-evaluation\\artphoto\\artphoto-cm.png'
    # plot_confusion_matrix(gpt4v_path, save_path)

    ## 找到拒识样本，并分析拒识case
    from toolkit.utils.functions import func_find_refused_samples
    label_path = 'E:\\Dataset\\gpt4v-evaluation\\artphoto\\label.csv'
    gpt4v_path = 'E:\\Dataset\\gpt4v-evaluation\\artphoto\\label-gpt4v.csv'
    store_root = 'E:\\Dataset\\gpt4v-evaluation\\artphoto\\refuse_samples'
    image_root = 'E:\\Dataset\\gpt4v-evaluation\\artphoto\\image'
