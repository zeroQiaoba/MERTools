...
def init_model():
    ...
    cfg.model.vit_blip_model_path = config.PATH_TO_MLLM['umt_l16_qformer']
    cfg.model.llama_model_path = config.PATH_TO_MLLM['vicuna-7b-v0']
    cfg.model.videochat2_model_path = config.PATH_TO_MLLM['videochat2_7b_stage2']
    ...
    state_dict = torch.load(config.PATH_TO_MLLM['videochat2_7b_stage3'], "cpu")
...
if __name__ == "__main__":
    ...
    for dataset in process_datasets:
        ...
        save_root = f'../output/results-{dataset.lower()}/VideoChat2'
